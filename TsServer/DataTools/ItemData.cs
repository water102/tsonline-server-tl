...
namespace Ts.DataTools
{
    ...
    public struct ItemInfo
    {
        ...
        public uint[] ColorDef;
        public byte unk4;
        public byte level;
        public uint BuyingPrice;
    ...
    public static class ItemData
    {
        ...
        public static void DecodeItem32(ref uint val)
        {
        ...
        public static void DecodeItem16(ref ushort val)
        {
        ...
        public static bool LoadItems()
        {
            try
            {
                using (FileStream fs = new FileStream("data/item.dat", FileMode.Open, FileAccess.Read))
                {
